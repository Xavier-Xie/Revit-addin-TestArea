...
namespace RevitAddin_test1
{
    ...
    {
        public static PushButton RevitAddin_test1Button { get; set; }
        ...
        private void Application_ViewActivated(object sender, Autodesk.Revit.UI.Events.ViewActivatedEventArgs e)
        {
            ...
            RevitAddin_test1UserControl.Instance.TextBlockProjectTitle.Text = app.ActiveUIDocument.Document.Title;
        }


        public Result OnShutdown(UIControlledApplication a)
        {
            RevitAddin_test1Button.Enabled = true;
            return Result.Succeeded;
        }
        ...
        private void OnButtonCreate(UIControlledApplication application)
        {
            ...
            string dllLocation = Path.Combine(executableLocation, "RevitAddin_test1.dll");

            // Create two push buttons

            PushButtonData buttondata = new PushButtonData("RevitAddin_test1Btn", buttonText, dllLocation, "RevitAddin_test1.Command");
            buttondata.ToolTip = buttonTooltip;

            BitmapImage pb1Image = new BitmapImage(new Uri("pack://application:,,,/RevitAddin_test1;component/Resources/icon.ico"));
            buttondata.LargeImage = pb1Image;

            var ribbonPanel = RibbonPanel(application);


            RevitAddin_test1Button = ribbonPanel.AddItem(buttondata) as PushButton;
